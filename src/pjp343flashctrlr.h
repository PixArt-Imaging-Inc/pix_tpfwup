#ifndef __PJP343_FLASH_CONTROLLER__
#define __PJP343_FLASH_CONTROLLER__
#include <stdint.h>
...
namespace pixart
{
    class Pjp343FlashCtrlr : public FlashController
    {
    public:
    ...
    public:
        Pjp343FlashCtrlr(RegisterAccessor *regAccessor);
        ~Pjp343FlashCtrlr();
    ...
    public:
        ...
        bool writeSramToFlash(uint32_t page, byte length);
        // Read
